      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">ECA</h1>
            <p className="text-gray-500 text-sm mt-1">Sistema de Gestión de Reciclaje</p>
          </div>
            ...
            <div className="w-full">
              ...
              <div className="relative">
                <input
                  ...
                  className={`
                    w-full rounded-lg border px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 pr-10
